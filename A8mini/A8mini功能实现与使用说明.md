...
> 2026-09-17：实机任务入口、退出和降落流程已更新，请先阅读
> [实机操作指南](../docs/A8mini实机操作指南.md)。本页的 YAML 云台任务需显式传
> `mission_source:=preset`，整栈入口用 `MISSION_SOURCE=preset`；默认点击模式不再回退 YAML。
> 落地/故障锁止后下一次飞行需要重启整栈。当前验证范围见[修复说明](../docs/2026-09-17_修复-A8mini-report.md)。
